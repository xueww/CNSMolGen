def preprocess_data(filename_in='../data/chembl_smiles', filename_out='', model_type=' CNSMolGen', starting_point='fixed',
    ...
    """Pre-processing of SMILES based on the user-defined parameters
        ...
        :param model_type      model to be used after data preparation -- default = ' CNSMolGen'
